...
entity uart_rx is 
    ...
    port(
        ...
        rx_out      : out std_logic_vector(0 to n - 1);
...
architecture behavioral of uart_rx is
    ...
    signal rx_out_lower, rx_out_higher              : std_logic_vector(n/2 - 1 downto 0);
    signal rx_out_lower_prev, rx_out_higher_prev    : std_logic_vector(n/2 - 1 downto 0);
...
begin
    ...
    rx_out_reg(n/2 - 1 downto 0) <= rx_out_lower;
    rx_out_reg(n - 1 downto n/2) <= rx_out_higher;
