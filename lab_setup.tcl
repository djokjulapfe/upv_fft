...
# set_location_assignment PIN_AA15 -to tx_start
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_start
...
# set_location_assignment PIN_Y21 -to rx_int
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to rx_int
#============================================================
# PS2
#============================================================
...
#============================================================
 ...
 set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to reset
# set_location_assignment PIN_AC12 -to tx_in[0]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[0]
# set_location_assignment PIN_AF9 -to tx_in[1]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[1]
# set_location_assignment PIN_AF10 -to tx_in[2]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[2]
# set_location_assignment PIN_AD11 -to tx_in[3]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[3]
# set_location_assignment PIN_AD12 -to tx_in[4]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[4]
# set_location_assignment PIN_AE11 -to tx_in[5]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[5]
# set_location_assignment PIN_AC9 -to tx_in[6]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[6]
# set_location_assignment PIN_AD10 -to tx_in[7]
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to tx_in[7]
...
# set_location_assignment PIN_Y17 -to tx_out
